classdef RegistrationGUI < matlab.apps.AppBase
    ...
    % obj = RegistrationGUI() class creates a GUI that matches an already created
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = RegistrationGUI(image_file_name, template_file_name)
            ...
            try
                loadImage(app, image_file_name)
                loadTemplate(app, template_file_name)
            catch
            end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Name = 'Atlas Registration';
...
%             Create UIAxes
    ...
    methods (Access = private, Static = true)
        ...
        function pos = customWait(hROI)
            ...
            l = addlistener(hROI,'ROIClicked',@RegistrationGUI.clickCallback);
    ...
    methods (Access = private)
        ...
        function FinishButtonPushed(app, event)
            ...
            warning('on', 'MATLAB:contour:ConstantData')                          % Restore MATLAB warning
